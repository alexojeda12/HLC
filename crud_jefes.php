...
if (isset($_POST['accion']) && $_POST['accion'] == 'insertar') {
    ...
    $query = "INSERT INTO jefes (nombre, ubicacion, requisito_historia) VALUES ('$nombre', '$ubicacion', '$requisito_historia')";
...
if (isset($_POST['accion']) && $_POST['accion'] == 'eliminar') {
    $id = $_POST['id'];
    $query = "DELETE FROM jefes WHERE id = $id";
    $conexion->query($query);
}
...
if (isset($_POST['accion']) && $_POST['accion'] == 'actualizar') {
    ...
    $query = "UPDATE jefes SET nombre = '$nombre', ubicacion = '$ubicacion', requisito_historia = '$requisito_historia' WHERE id = $id";
    $conexion->query($query);
}
...
if (isset($_GET['editar'])) {
    $id = $_GET['editar'];
    $query = "SELECT * FROM jefes WHERE id = $id";
