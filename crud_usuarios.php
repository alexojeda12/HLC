...
if (isset($_POST['accion']) && $_POST['accion'] == 'insertar') {
    ...
    $query = "INSERT INTO usuarios (nombre_usuario, email, contraseña, rol) VALUES ('$nombre', '$email', '$contrasena', '$rol')";
...
if (isset($_POST['accion']) && $_POST['accion'] == 'actualizar') {
    ...
    $query = "UPDATE usuarios SET nombre_usuario = '$nombre', email = '$email', rol = '$rol' WHERE id = $id";
    if (mysqli_query($conexion, $query)) {
...
if (isset($_GET['editar'])) {
    ...
    $usuario_para_actualizar = mysqli_fetch_assoc($resultado);
}
?>
